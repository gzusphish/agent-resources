...
```bash
cp -r conversation-manager/ ~/.claude/skills/           # Claude Code
cp -r conversation-manager/ .windsurf/skills/          # Windsurf
cp -r conversation-manager/ .github/skills/          # GitHub Copilot
```
