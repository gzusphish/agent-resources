...
```bash
cp -r skills/subgoal-decomposer/ ~/.claude/skills/           # Claude Code
cp -r skills/subgoal-decomposer/ .windsurf/skills/          # Windsurf
cp -r skills/subgoal-decomposer/ ~/.github/copilot/skills/  # Copilot
```
