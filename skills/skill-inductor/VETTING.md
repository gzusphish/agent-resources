...
```bash
cp -r skills/skill-inductor/ ~/.claude/skills/           # Claude Code
cp -r skills/skill-inductor/ .windsurf/skills/          # Windsurf
cp -r skills/skill-inductor/ .github/skills/          # GitHub Copilot
```
