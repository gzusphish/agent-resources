...
- **Repository URL**: https://gitlab.com/agora.panopticon/bespoke-agent-external.git (agent-resources/skills/skill-vetter/)
...
```bash
cp -r skills/skill-vetter/ ~/.claude/skills/           # Claude Code
cp -r skills/skill-vetter/ .windsurf/skills/          # Windsurf
cp -r skills/skill-vetter/ .github/skills/          # GitHub Copilot
```
