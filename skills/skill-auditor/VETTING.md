...
```bash
cp -r skills/skill-auditor/ ~/.claude/skills/           # Claude Code
cp -r skills/skill-auditor/ .windsurf/skills/          # Windsurf
cp -r skills/skill-auditor/ .github/skills/          # GitHub Copilot
```
