...
cp -r agent-external/k-dense-ai-claude-scientific-skills/scientific-skills/exploratory-data-analysis agent-resources/skills/
...
|------|----------|--------|---------|-------------|
| 2026-04-07 | agent-resources/skills/ | copy from agent-external | 1.0.0 | No original VETTING.md to compare |
