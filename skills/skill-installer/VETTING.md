...
```bash
cp -r skills/skill-installer/ ~/.claude/skills/           # Claude Code
cp -r skills/skill-installer/ .windsurf/skills/          # Windsurf
cp -r skills/skill-installer/ .github/skills/          # GitHub Copilot
```
