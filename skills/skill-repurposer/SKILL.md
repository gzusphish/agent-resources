...
```bash
# Load original skill
cat agent-resources/skills/skill-name/SKILL.md

# Check structure
ls -la agent-resources/skills/skill-name/
```
...
```bash
mkdir agent-resources/skills/repurposed-skill-name/
cp agent-resources/skills/source-skill/SKILL.md agent-resources/skills/repurposed-skill-name/
